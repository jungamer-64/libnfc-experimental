...
SET(_LIBNFC_ACR122_USB_SOURCE "${PROJECT_SOURCE_DIR}/libnfc/drivers/acr122_usb.c")
IF(LIBNFC_DRIVER_ACR122_USB AND NOT EXISTS "${_LIBNFC_ACR122_USB_SOURCE}")
  MESSAGE(WARNING "ACR122 USB driver sources are not available in this tree; disabling LIBNFC_DRIVER_ACR122_USB. Use the pn53x_usb driver instead.")
  SET(LIBNFC_DRIVER_ACR122_USB OFF CACHE BOOL "Enable ACR122 support (Direct USB connection)" FORCE)
ENDIF()
