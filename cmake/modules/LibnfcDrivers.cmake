...
IF(LIBNFC_DRIVER_PN71XX)
  ...
  SET(DRIVERS_SOURCES ${DRIVERS_SOURCES} "drivers/pn71xx.c")
ENDIF(LIBNFC_DRIVER_PN71XX)

IF(ACR122_CORE_REQUIRED)
  SET(DRIVERS_SOURCES ${DRIVERS_SOURCES} "drivers/acr122-core.c")
ENDIF(ACR122_CORE_REQUIRED)
