...
#[doc(hidden)]
pub struct RegisteredDriverSet<T> {
    drivers: Vec<T>,
}
...
impl<T> RegisteredDriverSet<T> {
    ...
    #[doc(hidden)]
    pub fn register(&mut self, driver: T) -> Result<(), std::collections::TryReserveError> {
    ...
    #[doc(hidden)]
    pub fn register_builtins_if_empty<I>(
        &mut self,
        drivers: I,
...
impl DriverRegistry {
    ...
    pub fn register_builtin_drivers(&mut self) {
        crate::native::register_builtin_drivers(self);
    }
